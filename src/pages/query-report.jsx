...
const mockGeneratedReports = [{
  ...
  reportType: 'thalassmia',
  generateTime: '2025-01-15 13:45:00',
  status: 'completed',
  fileSize: '1.8MB',
  reportName: '地贫模式报告_20250115'
}];
export default function QueryReportPage(props) {
  ...
  const handleGenerateReport = async () => {
    if (!queryParams.workOrder && !queryParams.columnSn && !queryParams.orderNumber && !queryParams.instrumentSerial) {
      toast({
        title: "查询条件不足",
    ...
    try {
      ...
      const newReport = {
        ...
        columnSn: queryParams.columnSn || 'COL-' + Date.now(),
        ...
        reportType: queryParams.reportType === 'all' ? 'glycation' : queryParams.reportType,
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
              ...
              <div>
                ...
                <Input placeholder="请输入层析柱序列号" value={queryParams.columnSn} onChange={e => setQueryParams({
                ...queryParams,
              ...
              <div>
                ...
                reportType: value
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="thalassmia">地贫模式报告</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div>
